...
import type { Feature } from '@/lib/rate-watch/tier-engine';
import type { Tier } from '@/lib/rate-watch/types';
      ...
      <div className="absolute right-0 top-0 flex h-full w-full max-w-lg flex-col bg-white shadow-2xl">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-6 py-5">
          ...
          <p className="pt-1 text-center text-xs text-slate-400">
            14-day free trial on both plans. Cancel anytime · powered by Stripe.
          </p>
        </div>
      </div>
    </div>
