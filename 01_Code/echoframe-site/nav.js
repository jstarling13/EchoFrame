(function () {
  ...
  var css = [
    ...
    '.ef-active-badge{margin-left:auto;flex-shrink:0;background:#94681C;color:#fff;font-size:10px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;padding:2px 7px;border-radius:5px}',
